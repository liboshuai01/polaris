...
MySQL Backup
Database: mall
Backup Time: 2022-09-10 09:21:43
*/

SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `mall`.`cms_help`;
DROP TABLE IF EXISTS `mall`.`cms_help_category`;
DROP TABLE IF EXISTS `mall`.`cms_member_report`;
DROP TABLE IF EXISTS `mall`.`cms_prefrence_area`;
DROP TABLE IF EXISTS `mall`.`cms_prefrence_area_product_relation`;
DROP TABLE IF EXISTS `mall`.`cms_subject`;
DROP TABLE IF EXISTS `mall`.`cms_subject_category`;
DROP TABLE IF EXISTS `mall`.`cms_subject_comment`;
DROP TABLE IF EXISTS `mall`.`cms_subject_product_relation`;
DROP TABLE IF EXISTS `mall`.`cms_topic`;
DROP TABLE IF EXISTS `mall`.`cms_topic_category`;
DROP TABLE IF EXISTS `mall`.`cms_topic_comment`;
DROP TABLE IF EXISTS `mall`.`oms_cart_item`;
DROP TABLE IF EXISTS `mall`.`oms_company_address`;
DROP TABLE IF EXISTS `mall`.`oms_order`;
DROP TABLE IF EXISTS `mall`.`oms_order_item`;
DROP TABLE IF EXISTS `mall`.`oms_order_operate_history`;
DROP TABLE IF EXISTS `mall`.`oms_order_return_apply`;
DROP TABLE IF EXISTS `mall`.`oms_order_return_reason`;
DROP TABLE IF EXISTS `mall`.`oms_order_setting`;
DROP TABLE IF EXISTS `mall`.`pms_album`;
DROP TABLE IF EXISTS `mall`.`pms_album_pic`;
DROP TABLE IF EXISTS `mall`.`pms_brand`;
DROP TABLE IF EXISTS `mall`.`pms_comment`;
DROP TABLE IF EXISTS `mall`.`pms_comment_replay`;
DROP TABLE IF EXISTS `mall`.`pms_feight_template`;
DROP TABLE IF EXISTS `mall`.`pms_member_price`;
DROP TABLE IF EXISTS `mall`.`pms_product`;
DROP TABLE IF EXISTS `mall`.`pms_product_attribute`;
DROP TABLE IF EXISTS `mall`.`pms_product_attribute_category`;
DROP TABLE IF EXISTS `mall`.`pms_product_attribute_value`;
DROP TABLE IF EXISTS `mall`.`pms_product_category`;
DROP TABLE IF EXISTS `mall`.`pms_product_category_attribute_relation`;
DROP TABLE IF EXISTS `mall`.`pms_product_full_reduction`;
DROP TABLE IF EXISTS `mall`.`pms_product_ladder`;
DROP TABLE IF EXISTS `mall`.`pms_product_operate_log`;
DROP TABLE IF EXISTS `mall`.`pms_product_vertify_record`;
DROP TABLE IF EXISTS `mall`.`pms_sku_stock`;
DROP TABLE IF EXISTS `mall`.`sms_coupon`;
DROP TABLE IF EXISTS `mall`.`sms_coupon_history`;
DROP TABLE IF EXISTS `mall`.`sms_coupon_product_category_relation`;
DROP TABLE IF EXISTS `mall`.`sms_coupon_product_relation`;
DROP TABLE IF EXISTS `mall`.`sms_flash_promotion`;
DROP TABLE IF EXISTS `mall`.`sms_flash_promotion_log`;
DROP TABLE IF EXISTS `mall`.`sms_flash_promotion_product_relation`;
DROP TABLE IF EXISTS `mall`.`sms_flash_promotion_session`;
DROP TABLE IF EXISTS `mall`.`sms_home_advertise`;
DROP TABLE IF EXISTS `mall`.`sms_home_brand`;
DROP TABLE IF EXISTS `mall`.`sms_home_new_product`;
DROP TABLE IF EXISTS `mall`.`sms_home_recommend_product`;
DROP TABLE IF EXISTS `mall`.`sms_home_recommend_subject`;
DROP TABLE IF EXISTS `mall`.`ums_admin`;
DROP TABLE IF EXISTS `mall`.`ums_admin_login_log`;
DROP TABLE IF EXISTS `mall`.`ums_admin_permission_relation`;
DROP TABLE IF EXISTS `mall`.`ums_admin_role_relation`;
DROP TABLE IF EXISTS `mall`.`ums_growth_change_history`;
DROP TABLE IF EXISTS `mall`.`ums_integration_change_history`;
DROP TABLE IF EXISTS `mall`.`ums_integration_consume_setting`;
DROP TABLE IF EXISTS `mall`.`ums_member`;
DROP TABLE IF EXISTS `mall`.`ums_member_level`;
DROP TABLE IF EXISTS `mall`.`ums_member_login_log`;
DROP TABLE IF EXISTS `mall`.`ums_member_member_tag_relation`;
DROP TABLE IF EXISTS `mall`.`ums_member_product_category_relation`;
DROP TABLE IF EXISTS `mall`.`ums_member_receive_address`;
DROP TABLE IF EXISTS `mall`.`ums_member_rule_setting`;
DROP TABLE IF EXISTS `mall`.`ums_member_statistics_info`;
DROP TABLE IF EXISTS `mall`.`ums_member_tag`;
DROP TABLE IF EXISTS `mall`.`ums_member_task`;
DROP TABLE IF EXISTS `mall`.`ums_permission`;
DROP TABLE IF EXISTS `mall`.`ums_role`;
DROP TABLE IF EXISTS `mall`.`ums_role_permission_relation`;
...
CREATE TABLE `pms_brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='品牌表';
