package com.liboshuai.mall.common.constants;
...
public class DatePattern {
    ...
    public static final FastDateFormat AD_DATETIME_FORMAT = FastDateFormat.getInstance(AD_DATETIME_PATTERN);// 公元 2019-01-01 +0800 星期二 10:39:06:863 下午
    ...
    static {
        HTTP_DATETIME_FORMAT = FastDateFormat.getInstance(HTTP_DATETIME_PATTERN, TimeZone.getTimeZone("GMT"), Locale.US);
